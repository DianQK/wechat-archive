...
CREATE TABLE IF NOT EXISTS `wa_contact`( -- rcontact
   ...
   `nickname` VARCHAR(100) DEFAULT NULL COMMENT '微信昵称',
   `py_initial` VARCHAR(100) DEFAULT NULL,
   `quan_pin` VARCHAR(100) DEFAULT NULL,
   `show_head` INTEGER DEFAULT 0,
   `type` INTEGER DEFAULT 0,
   `weibo_flag` INTEGER DEFAULT 0,
   `weibo_nickname` VARCHAR(100) DEFAULT NULL,
   `con_remark_py_full` VARCHAR(100) DEFAULT NULL,
   `con_remark_py_short` VARCHAR(100) DEFAULT NULL,
   ...
   `contact_label_ids` VARCHAR(100) DEFAULT NULL,
   `desc_wording_id` VARCHAR(100) DEFAULT NULL,
   `open_im_appid` VARCHAR(100),
   `source_ext_info` VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS `wa_message`( -- message
   `wa_owner` VARCHAR(40) NOT NULL COMMENT '属于谁的消息',
...
CREATE TABLE IF NOT EXISTS `wa_img_info`( -- ImgInfo2
   ...
   `big_img_path` VARCHAR(100) NOT NULL, 
   ...
   `orig_img_md5` VARCHAR(100) DEFAULT NULL, 
